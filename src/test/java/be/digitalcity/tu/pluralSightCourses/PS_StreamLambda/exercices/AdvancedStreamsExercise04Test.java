...
import be.digitalcity.tu.pluralSightCourses.PS_StreamLambda.exercises.AdvancedStreamsExercise04;
...
class AdvancedStreamsExercise04Test {
    ...
    private final AdvancedStreamsExercise04 exercise = new AdvancedStreamsExercise04();
